class DropBoxController{
	...
	connectFirebase(){
		...
		var config = {
		apiKey: "AIzaSyCPmYMS7VjcvoKAPezf5u-ogJOAlqW8t2U",
		authDomain: "donizeti-drop-box.firebaseapp.com",
		databaseURL: "https://donizeti-drop-box.firebaseio.com",
		projectId: "donizeti-drop-box",
		storageBucket: "donizeti-drop-box.appspot.com",
		messagingSenderId: "746482448960"
	  };
